      ...
      <div className="container BrokerageContainer p-5">
        <div className="row">
          <div className="table-responsive">
            ...
            <table className="table table-borderless align-middle equal-columns">
              <thead>
            ...
            <h4 className="text-center mt-5 text-muted"><a style={{textDecoration:"none" , color:"#387ed1"}} href="#">Calculate your costs upfront</a> using our brokerage calculator</h4>
          </div>
        </div>
      </div>
    </div>
